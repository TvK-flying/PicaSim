...
bool Wing::ReadFromXML(class TiXmlElement* wingElement, AerofoilData& aerofoilData)
{
    ...
    readFromXML(wingElement, "vectorEngineName", mVectorEngineName);
